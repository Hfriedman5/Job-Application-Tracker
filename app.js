...
function updateStats() {
    ...
    // Application breakdown (simplified)
    ...
    // Avg per week (simplified: weeks since first application)
    ...
    const avgPerWeek = weeksSinceFirst > 0 ? (total / weeksSinceFirst).toFixed(1) : total;
